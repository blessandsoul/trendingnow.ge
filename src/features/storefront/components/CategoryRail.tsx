    ...
    <section className="storefront-container mt-5">
      <div className="no-scrollbar grid auto-cols-[minmax(206px,72vw)] grid-flow-col snap-x gap-3 overflow-x-auto px-1 pb-2 sm:grid-flow-row sm:grid-cols-3 sm:overflow-visible sm:px-0 lg:grid-cols-7">
        {categories.slice(0, 6).map((category) => {
          ...
          return (
            <Link
              ...
              className="group snap-start overflow-hidden border border-[#D9DDE7] bg-white p-2 shadow-[0_8px_24px_rgba(17,20,27,0.04)] transition-[transform,box-shadow,border-color] duration-300 ease-out hover:-translate-y-1 hover:border-[#092BB4] hover:shadow-[0_18px_34px_rgba(17,20,27,0.1)] active:translate-y-px motion-reduce:transition-none"
            >
              {imageUrl && (
              ...
              <span className="block min-w-0 px-1.5 pb-1 pt-3 text-[#101010]">
                <span className="block break-words text-[15px] font-bold leading-[1.18] tracking-[-0.025em] sm:text-base">{displayName}</span>
        ...
        <Link
          ...
          className="group relative min-h-[190px] snap-start overflow-hidden border border-[#101010] bg-[#101010] p-5 text-white shadow-[0_8px_24px_rgba(17,20,27,0.08)] transition-[transform,box-shadow] duration-300 ease-out hover:-translate-y-1 hover:shadow-[0_18px_34px_rgba(17,20,27,0.18)] active:translate-y-px motion-reduce:transition-none"
        >
          <span className="absolute -right-8 -top-10 h-40 w-16 rotate-[24deg] bg-[#092BB4]" aria-hidden="true" />
          <span className="relative grid size-12 shrink-0 place-items-center rounded-full bg-white text-[#101010]">
            <MoreHorizontal className="size-5" strokeWidth={2.25} />
          </span>
          <span className="relative mt-10 block min-w-0 break-words text-[16px] font-bold leading-[1.22] tracking-[-0.025em]">
